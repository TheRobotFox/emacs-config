...
(custom-set-variables
 ...
 '(TeX-view-program-selection
   '(((output-dvi has-no-display-manager) "dvi2tty") ((output-dvi style-pstricks) "dvips and gv") (output-dvi "xdvi") (output-pdf "PDF Tools") (output-html "xdg-open")))
 '(custom-safe-themes
 ...
 '(straight-host-usernames '((github . "TheRobotFox"))))
(custom-set-faces
